    ...
    this.api.getDataWithToken("viewReview").subscribe((res: any) => {
      if (res.success) {
        ...
        if (res.data.userDetail.cover_image == null) {
          ...
          this.coverImage =
            this.userDetail.imagePath + this.data.userDetail.cover_image;
        }
    ...
    if (this.segment == 3) {
      ...
      this.api.postDataWithToken("editProfile", this.userDetail).subscribe(
        (res: any) => {
          if (res.success) {
            this.err = {};
            this.util.dismissLoader();
            this.util.presentToast("succesfully save your profile");
      ...
      this.api
        ...
        .subscribe((res: any) => {
          if (res.success) {
            this.util.dismissLoader();
            this.util.presentToast("Successfuly set your setting");
          }
        });
    }
  }
