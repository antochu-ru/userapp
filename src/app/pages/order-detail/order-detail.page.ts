...
export class OrderDetailPage implements OnInit {
  ...
  onSubmit(item) {
    ...
    this.api
      ...
      .subscribe((res: any) => {
        if (res.success) {
          this.util.presentToast("successfully Added Item review");
  ...
  shopReiviewData(item) {
    ...
    this.api
      ...
      .subscribe((res: any) => {
        if (res.success) {
          this.util.presentToast("successfully Added shop review");
  ...
  driverReviewData(item) {
    ...
    this.api.postDataWithToken("addDriverReview", this.driverReview).subscribe(
      (res: any) => {
        if (res.success) {
          this.err = {};
          this.util.presentToast("successfully Added driver review");
